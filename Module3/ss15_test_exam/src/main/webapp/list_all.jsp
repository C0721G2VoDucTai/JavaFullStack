                ...
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-success text-white">
                            <a class="text-white" href="/book?note=create">Statistical book</a>
                        </button>
                    </div>
                    <div class="col-9" align="right">
                        <form method="post" action="/book?note=search">
                ...
                <table id="tableStudent" class="table table-striped table-bordered" style="width:100% content-box">
                    ...
                    <c:forEach var="ticket" items="${ticketList}" varStatus="count">
                        <tr>
                            ...
                            <td>${ticket.book.writer}</td>
                            <td>${ticket.student.name}</td>
                            <td>${ticket.student.grade}</td>
                            <td>${ticket.starDay}</td>
                            <td>${ticket.endDay}</td>
                            <td class="text-center">
                                <a href="/book?note=edit&id=${ticket.id}"
                                   role="button" class="btn btn-large btn-warning">Tra sach</a>
                            </td>
                            <td>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="modelId-${ticket.id}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Are you sure delete Land có Id = ${ticket.id}
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-success" data-dismiss="modal">
                                            <a href="/book?note=delete&id=${ticket.id}" role="button" class="btn-success text-light">
                                                Accept </a></button>
                                    </div>
                                </div>
                            </div>
