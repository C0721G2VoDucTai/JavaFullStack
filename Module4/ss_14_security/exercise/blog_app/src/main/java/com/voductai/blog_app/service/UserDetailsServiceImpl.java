...
import com.voductai.blog_app.repository.AppUserRepository;
import com.voductai.blog_app.repository.UserRoleRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
       //Tìm đối tượng đang đăng nhập trong DB
        //Từ tham số userNam tìm trong database trả về đối tương username
