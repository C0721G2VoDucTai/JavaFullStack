                ...
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-success text-white">
                            <a class="text-white" href="/employee?note=create">Add new employee</a>
                        </button>
                    </div>
                    <div class="col-6" align="right">
                        <form action="/employee?note=search" method="post">
                            <label> <input type="search" name="employeeName" placeholder="search name"></label>
                ...
                <c:forEach var="employee" items="${employeeList}" varStatus="count">
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/employee?note=edit&id=${employee.id}"
