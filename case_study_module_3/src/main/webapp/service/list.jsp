        ...
        <div class="col-lg-12">
            <div class="container col-12">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-success text-white">
                            <a class="text-white" href="/service?note=create">Add new user</a>
                        </button>
                    </div>
                    <div class="col-6" align="right">
                        <form action="/service&note=search" method="post">
                ...
                <table id="tableStudent" class="table table-striped table-bordered" style="width:100% content-box">
                    ...
                    <tbody>
                    <c:forEach var="service" items="${serviceList}" varStatus="count">
                        <tr>
                            <td>${service.id}</td>
                            <td>${service.name}</td>
                            <td>${service.area}</td>
                            ...
                            <td class="text-center">
                                <a href="/service?note=edit&id=${service.id}"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Are you sure delete Service có id = ${service.id} and name là: ${service.name}
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <a href="/service?note=delete&id=${service.id}" role="button" class="btn-danger">
                                            accept </a>
                                    </div>
                                </div>
                            </div>
